...
const GptSearchBar = () => {
  ...
  return (
    <div className="pt-[50%] md:p-[9%] flex justify-center opacity-90">
      <form className="w-full md:w-6/12 bg-black grid grid-flow-col grid-cols-12" onSubmit={(e)=>{e.preventDefault();}} >
        <input 
            ref={searchText}
            type="text" 
            placeholder={lang[langKey].gptSearchPlaceholder}
            className="p-1 md:p-4 m-4 col-span-9"
        ></input>
        <button 
